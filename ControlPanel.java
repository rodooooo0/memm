...
public class ControlPanel extends Frame
{
  ...
  public void init( Kernel useKernel , String commands , String config )
  {
    ...
    segmentLabel.reshape(285, 240+25, 150, 15);
    segmentLabel.setFont(new Font("Courier", Font.BOLD, 12));
    add(segmentLabel);

    pagesLabel.reshape(285, 255+25, 300, 15);
    pagesLabel.setFont(new Font("Courier", Font.PLAIN, 12));
    add(pagesLabel);

    // Nuevo: Colores para los botones segun segmento
    Color[] segmentColors = {
    ...
    // Para los primeros 32 botones (ajusta si usas mas paginas)
    for (int i=0; i<32; i++) {
      int seg = 0;
  ...
  // METODO NUEVO: Para actualizar la etiqueta de las paginas involucradas
